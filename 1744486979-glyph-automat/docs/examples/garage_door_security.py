...
class GarageController(typing.Protocol):
    def pushButton(self, remoteID: str) -> None:
...
def startOpening(controller: GarageController, devices: DoorDevices, remoteID: str) -> None:
    print(f"opened by {remoteID}")
    devices.motor.up()
...
def startClosing(controller: GarageController, devices: DoorDevices, remoteID: str) -> None:
    print(f"closed by {remoteID}")
    devices.alarm.beep()
    devices.motor.down()
...
if __name__ == "__main__":
    ...
    # do open
    machine.pushButton("alice")
    # end open
    print("pushed")
    try:
        machine.pushButton("bob")
    except NoTransition:
        print("this is not implemented yet")
    print("triggering open sensor, pushing button again")
    # sensor and close
    machine.openSensor()
    machine.pushButton("carol")
    # end close
    print("pushed")
    machine.closeSensor()
